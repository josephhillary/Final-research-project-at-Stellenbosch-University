...
\newtheorem{Rem}[subsection]{Conclusions}
...
\title{Lie Group Analysis of a Nonlinear  Coupled System of \newline Korteweg-de Vries Equations}
...
% University of Stellenbosch, South Africa
{\small Supervised by: Professor Chaudry Masood Khalique}\\
{\small North-West University, South Africa}%
% Don't put the department, it becomes too long.
}
\date{{\small 14 May  2020}\\%
...
\input{chapter3} % You do not need to ha\usepackage[maxlevel=3]{csquotes}ve exactly 4 chapters.
